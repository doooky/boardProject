...
interface BoardRepository : JpaRepository<Board, Long> {
    ...
    // 대소문자 무시하고 게시물 제목 검색
    fun findByCategoryIdxAndTitleContainingIgnoreCase(categoryIdx: Long, title: String, pageable: Pageable): List<Board?>?
    fun findByCategoryIdx(categoryIdx: Long, pageable: Pageable): List<Board?>?
